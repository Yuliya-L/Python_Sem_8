...
data = {
     'items': ['компьютер', 'принтер', 'клавиатура', 'мышь'],
     'items_quantity': 4,
     'items_price': {
         'компьютер': '10000 рублей -100000 рублей',
         'клавиатура': '100 рублей -500 рублей',
         'мышь': '10 рублей-50 рублей',
         'принтер': '3000 рублей - 10000 рублей'
     }
 }
